...
<!--    </section>-->
                      ...
                      <li>
                        <div class="course-box d-flex flex-wrap w-100">
                          ...
                          <div class="course-inner">
                            ...
                            <p class="mb-0">Every Tuesday & Wednesday 8:00 am to 12:00 pm</p>
                          </div>
                        </div>
                      </li>
                      <li>
              ...
              <div class="col-md-6 col-sm-6 col-lg-4">
                <div class="event-box w-100">
                  ...
                  <div class="event-info pat-bg gray-layer opc85 position-relative back-blend-multiply gray-bg w-100" style="background-image: url(assets/images/pattern-bg.jpg);">
                    ...
                    <h3 class="mb-0"><a href="event-detail.html" title="">Ramadan, A Month Of Blessing</a></h3>
              ...
              <div class="col-md-6 col-sm-6 col-lg-4">
                <div class="event-box w-100">
                  ...
                  <div class="event-info pat-bg gray-layer opc85 position-relative back-blend-multiply gray-bg w-100" style="background-image: url(assets/images/pattern-bg.jpg);">
                    ...
                    <h3 class="mb-0"><a href="event-detail.html" title="">Children Islamic Teaching Event Study</a></h3>
                    <span class="event-time d-block thm-clr">8:47am - 10:00am</span>
              ...
              <div class="col-md-6 col-sm-6 col-lg-4">
                <div class="event-box w-100">
                  ...
                  <div class="event-info pat-bg gray-layer opc85 position-relative back-blend-multiply gray-bg w-100" style="background-image: url(assets/images/pattern-bg.jpg);">
                    ...
                    <h3 class="mb-0"><a href="event-detail.html" title="">Eid-ul-Adha, Feast o Scrifice</a></h3>
                    <span class="event-time d-block thm-clr">8:47am - 10:00am</span>
    ...
    <div class="bottom-bar dark-bg2 text-center w-100">
      <p class="mb-0"><a href="index-2.html" title="Home">Maktab</a> - Copyright 2020. Design by <a href="https://themeforest.net/user/nauthemes/portfolio" title="Nauthemes" target="_blank">Nauthemes</a></p>
    </div><!-- Bottom Bar -->
</template>
        ...
        data () {
            return {
                caurosel_content: [
                    {
                      title: "First Panel",
                      desc: "This is the first Panel", 
                      image_url: "https://bit.ly/3FN34Z9"
                    },
                    {
                      title: "Second Panel",
                      desc: "This is the Second Panel", 
                      image_url: "https://bit.ly/3sP2IgH"
                    },
                    {
                      title: "Third Panel",
                      desc: "This is the third Panel", 
                      image_url: "https://bit.ly/3JycFFq"
                    },
                    {
                      title: "Fourth Panel",
                      desc: "This is the fourth Panel", 
                      image_url: "https://bit.ly/32L0STf"
                    }
                ]
            }
        },
